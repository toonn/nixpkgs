...
let
  ...
  sdk = stdenv.mkDerivation rec {
    ...
    #  4. Profit
    src = fetchurl {
      url    = "https://swcdn.apple.com/content/downloads/50/15/041-91747-A_WICZE7RNVZ/rayjnqf847xflt3tan8o8agod67eq88cav/DevSDK_macOS1013_Public.pkg";
    ...
    installPhase = ''
      ...
      cp ${darwin-stubs}/usr/lib/libcups*.tbd $out/lib/
    '';
